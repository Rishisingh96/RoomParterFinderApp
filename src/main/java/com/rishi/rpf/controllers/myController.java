...
import com.rishi.rpf.forms.UserForm;
...
public class myController {
    ...
    // about
    @RequestMapping("/partner_finder")
    public String partner_finder_page(Model model) {
        model.addAttribute("isLogin", true);
        System.out.println(" About page is login ");
        return "partner_finder";
    }
    ...
    public String processRegister(@Valid @ModelAttribute UserForm userForm, BindingResult rBindingResult,
        ...
        // user.setEnabled(false); // by default false if we want to disable the user
